...
class GSYNTHConfig(BaseEstimatorConfig):
    ...
    r: Optional[int] = Field(
        ...
        description=(
            ...
            "running minimum by more than 0.1%. That guard is gsynth 1.2.1's "
            "own tol default; gsynth 1.0 used 1%, so the two versions can "
            "choose different ranks on one panel when the improvement falls "
            "between them. That is the criterion gsynth "
