...
class CLUSTERSC:
    ...
    def __init__(self, config: Union[CLUSTERSCConfig, dict]) -> None:
        ...
        self.cluster_method: str = config.cluster_method
        self.weight_objective: str = config.weight_objective
        self.fgrc_c1: int = config.fgrc_c1
        self.fgrc_c2: int = config.fgrc_c2
        self.fgrc_k = config.fgrc_k
        self.fgrc_knots = config.fgrc_knots
        ...
        try:
            ...
            if self.method in {"rpca", "both"}:
                rpca_fit = run_rpca(
                    ...
                    fgrc_c1=self.fgrc_c1,
                    fgrc_c2=self.fgrc_c2,
                    fgrc_k=self.fgrc_k,
                    fgrc_knots=self.fgrc_knots,
