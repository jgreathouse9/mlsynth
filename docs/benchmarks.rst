...
.. BENCHMARK-INDEX-START (generated by tools/gen_benchmark_index.py)

Every case, by path and data
----------------------------

All 222 registered cases. ``paths`` is what the case
...
By data: 76 simulated, 131 empirical, 15 both -- so 91 cases fit at least one generated panel.
...
.. list-table::
   ...
   * - ``geox_augsynth_geolift``
     - X
     - empirical
   * - ``geox_augsynth_recast``
     - B X
     - simulated
   * - ``geox_mc``
     - C
     - both
   * - ``geox_mvbbsc_equivalence``
     - X
     - empirical
