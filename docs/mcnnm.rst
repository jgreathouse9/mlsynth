...
.. note::
   ...
   Cross-validation. The Prop-99 ATT is matched to the authors' own ``MCPanel``
   R package (``mcnnm_cv``) to :math:`0.15` packs and pinned in
   ``benchmarks/cases/mcnnm_prop99.py``; see the dedicated page
   :doc:`replications/mcnnm`.
