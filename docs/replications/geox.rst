...
:doc:`../geox` reports, for each candidate test region, a minimum
...
The panel is split. GEOX sees the first 48 periods and nothing else.
Experiments are then run on the held-out final 12 periods, with a lift
of known size injected and the analysis GEOX promises will be used --
