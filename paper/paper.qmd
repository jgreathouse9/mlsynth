...
comparison: on Abadie and Gardeazabal's Basque study, a nested solver and a provably
better bilevel one, which exist together in no other package, reach different
...
The library also ships a benchmark suite, ninety-four small re-runnable cases that
each hold an estimator to an outside answer rather than to its own past output. Each
...
Pinning an estimator to an outside answer in this way, a live reference or a
