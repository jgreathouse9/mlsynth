...
|:--|:--|:--|:--|
| `FDID` | Forward difference-in-differences | Single treated unit | A, B |
...
| `PDA` | Panel-data approach (HCW / lasso / forward / $\ell_2$) | Single treated unit | A, B |
| `BVSS` | Bayesian synthetic control (soft simplex) | Single treated unit | — |
| `ORTHSC` | Orthogonalized synthetic control | Single treated unit | A, B |
...
| `SBC` | Synthetic business cycle | Nonstationary outcomes | A, B |
| `HSC` | Harmonic synthetic control | Nonstationary outcomes | A, B |
| `DSCAR` | Dynamic SC for autoregressive processes | Nonstationary outcomes | A |
...
| `SCMO` | Synthetic control with multiple outcomes | Distributional and multi-outcome | A, B |
| `CMBSTS` | Causal multivariate Bayesian structural time series | Distributional and multi-outcome | A, X |
| `MUSC` | Modified unbiased synthetic control | Endogeneity, proxies and instruments | — |
| `SHC` | Synthetic historical control | Endogeneity, proxies and instruments | B |
...
| `MSQRT` | Multivariate square-root-lasso synthetic control | Endogeneity, proxies and instruments | B |
...
| `ROLLDID` | Rolling-transformation difference-in-differences | Many treated / staggered | A |
...
| `MAREX` | Synthetic control for experimental design | Experimental design | A |
