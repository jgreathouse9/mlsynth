...
CASES = {
    ...
    "arco_lasa": "benchmarks.cases.arco_lasa",                # Path A: Masini-Medeiros 2021 Table 5a -- WLASSO + partial resampling on their Brazilian retail price experiment, value-for-value
