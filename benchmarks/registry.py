...
CASES = {
    ...
    "fsc_okano": "benchmarks.cases.fsc_okano",  # Path A (pre-build): Okano-Kurisu 2026 functional SC -- all three applications, both fits each, and Tables 1-3 reproduced from the authors' data
