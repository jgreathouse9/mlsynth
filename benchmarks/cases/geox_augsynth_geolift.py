"""GEOX cross-validation: the augsynth engine against GeoLift's BestMarkets.

Cross-validation against the reference implementation. GEOX's scoring
...
``GEOX(engine="augsynth")`` reaches all five, with the rank, the MDE, the
