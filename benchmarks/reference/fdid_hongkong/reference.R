...
cat(sprintf("fdid_att\t%.12f\n", FDID$ATT_FDID))
cat(sprintf("fdid_att_pct\t%.12f\n", FDID$ATT_FDID_per))
cat(sprintf("fdid_r2_pre\t%.12f\n", FDID$R2_FDID))
cat(sprintf("fdid_n_controls\t%d\n", FDID$num_c))
cat(sprintf("did_att\t%.12f\n", ATT_DID))
cat(sprintf("did_att_pct\t%.12f\n", ATT_DID_per))
cat(sprintf("did_r2_pre\t%.12f\n", R2_DID))
cat("== SESSION INFO ==\n")
print(sessionInfo())
