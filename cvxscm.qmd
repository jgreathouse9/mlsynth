...
Explain why the standard Difference-in-Differences (DID) assumption of [parallel trends](did.html#def-pta), assessed through its testable [pre-trends](did.html#def-ppta) proxy, is problematic in small-$N$ settings, and how SCM addresses this issue. In particular, discuss their weighting schemes and what this implies.
:::
